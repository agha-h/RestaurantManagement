...
// Assuming history image is imported correctly at the top with other imports
import TopBorder from '../../images/about/top-border.png';
import BottomBorder from '../../images/about/btm-border.png';
import HistoryImage from '../../images/about/our-history.png'; // Adjust path as necessary
...
const About = () => (
  <section id="about">
    <div className="w-full h-full">
        ...
        >
          <div className="max-w-screen-lg w-full grid px-4 sm:grid-cols-2 gap-8 mx-auto text-white">
            <div className="flex justify-center items-center">
              <img src={HistoryImage} alt="The owners of Tokio Ramen" className="rounded drop-shadow-lg" />
            </div>
            <div>
              <p className="pb-2">
      ...
      <img src={BottomBorder} alt="" className="w-full" />
    </div>
  </section>
);
