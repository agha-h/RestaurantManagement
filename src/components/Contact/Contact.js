...
const Contact = () => {
  ...
  // Use the REACT_APP_ prefix for environment variables in a Create React App project
  const formId = process.env.REACT_APP_GETFORMIO_ID;
      ...
      <div className="w-full h-screen">
        <div className="h-full flex flex-col justify-center items-center">
          ...
          >
            ...
            >
              <div className="w-[75%] max-w-xl mx-auto">
