...
import Layout from '../components/Layout/Layout';// Your customized layout component

const IndexPage = () => (
  <Layout>
    <Helmet>
      <title>Boynton Beach, FL - Tokio Ramen</title>
    </Helmet>
    <div className="w-full h-screen">
      <div className="max-w-screen-md mx-auto px-8 flex flex-col justify-center h-full">
        <h1 className="mb-8 text-lg md:text-2xl font-normal tracking-wider uppercase">
          Sometimes, a smaller scale ramen shop just works.
        </h1>
        <p className="mb-8">
